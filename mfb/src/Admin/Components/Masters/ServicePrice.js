...
export default function ServicePriceList(props) {
  ...
  const applicationAPI = (
    url = "https://apimunnyfinds.azurewebsites.net/api/serviceprice/"
  ) => {
    return {
      fetchBusinessType: (id) => axios.get("https://apimunnyfinds.azurewebsites.net/api/businesstype/Get/"),
      fetchAll: () => axios.get(url + "get"),
      fetchBusiness: (id) => axios.get("https://apimunnyfinds.azurewebsites.net/api/business/GetByType/" + id),
      fetchCategory: (id) => axios.get("https://apimunnyfinds.azurewebsites.net/api/category/GetByType/" + id),
      fetchService: (id) => axios.get("https://apimunnyfinds.azurewebsites.net/api/service/GetByBusinessType/" + id),
